// Yes, it is possible for us to wait for the child to finish before paranet finishes. We can use signals to indicate that child has finished and parent can start and vice versa.
